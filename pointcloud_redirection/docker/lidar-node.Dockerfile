...
COPY scripts/lidar-node-entrypoint.sh /app/scripts/lidar-node-entrypoint.sh
RUN chmod +x /app/scripts/lidar-node-entrypoint.sh
ENTRYPOINT ["/app/scripts/lidar-node-entrypoint.sh"]
